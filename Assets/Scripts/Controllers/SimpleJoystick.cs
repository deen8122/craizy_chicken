...
namespace CnControls
{
    ...
    /// </summary>
    public class SimpleJoystick : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler,IPointerExitHandler
    {
        /// <summary>
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
			...
			GameManager.instance.setJoysticValues (horizontalValue,verticalValue,isLeft);
        }

        public void OnPointerUp(PointerEventData eventData)
        {
			GameManager.instance.JoystickUp (isLeft);
			...
			GameManager.instance.setJoysticValues (0,0,isLeft);
        ...
        public void OnPointerDown(PointerEventData eventData)
        {
			...
			GameManager.instance.JoystickDown (isLeft);
            if (SnapsToFinger)
            {
                CurrentEventCamera = eventData.pressEventCamera ?? CurrentEventCamera;
